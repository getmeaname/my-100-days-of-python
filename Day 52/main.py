...
ACCOUNT_TO_BE_SEARCHED = "ANY_ACCOUNT_TO_BE_SEARCHED"
USER_NAME = "USERNAME"
PASSWORD = "PASSWORD"
...
class InstaFollower:
    ...
    def login(self):
        ...
        login_button = self.driver.find_element("xpath", '//*[@id="loginForm"]/div/div[3]')
    ...
    def find_followers(self):
        ...
        self.driver.get(f"https://www.instagram.com/{ACCOUNT_TO_BE_SEARCHED}/followers/")
